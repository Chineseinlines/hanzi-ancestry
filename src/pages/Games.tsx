...
import {
  Pencil, Puzzle, Eye, ScrollText,  Brain, Trophy,
} from 'lucide-react';
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-2">
                        <h3 className="font-serif-cn text-base font-semibold text-ink-black">{game.title}</h3>
                      ...
                      <p className="mt-2 text-xs leading-relaxed text-charcoal/60" style={{ fontFamily: 'Inter' }}>
                        {game.desc}
                      </p>
                    </div>
                  </div>
