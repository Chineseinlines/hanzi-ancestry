...
const operators: IDSOperator[] = [
  ...
  { operator: '⿷', name: 'Surround from Left', nameZh: '左三包围', structure: 'A wraps B from left', structureZh: 'A从左侧包围B', example: '⿷匚矢', result: '医', example2: '⿷匚乂', result2: '区' },
  ...
  { operator: '⿻', name: 'Overlay', nameZh: '镶嵌结构', structure: 'A overlaps B', structureZh: 'A交叠B', example: '⿻工从', result: '巫', example2: '⿻从土', result2: '坐' },
